...
<template>
  ...
  <div class="mx-5">
    ...
    <p class="mb-3">
      ...
      SIREN sous le numéro 538 940 057, Livre officiel des affixes 18314, Certificat d'Etudes
      Techniques de l'animal de compagnie C-1671et Certificat de capacité délivré le 11/09/2012,
      (Ci-après « le Vendeur »).
    </p>
    <p class="mb-3">
      Nos chatons vivent avec nous à la maison et sont chouchoutés. Nous élevons nos chatons avec
      beaucoup d’amour et sommes attentifs au profil des futurs propriétaires.
    </p>
    <p class="mb-3">
      Les présentes conditions générales visent à définir les obligations réciproques des parties ainsi
      que les différentes étapes du processus d’achat d’un chaton destiné exclusivement à la
      compagnie. Elles précisent et complètent utilement les conditions générales de vente qui
      figurent au dos du contrat de vente d’un chaton.
    </p>
    <p class="mb-3">
      Toute réservation et achat d’un chaton implique l’acceptation totale et sans réserve des
      présentes conditions par l’adoptant.
    </p>
    <p class="mb-3">
      Le Vendeur se réserve la possibilité de modifier ces conditions générales de vente à tout
    ...
    <p class="mb-3">
      ...
      placé par son propriétaire dans des conditions compatibles avec les impératifs biologiques de
      son espèce.
    </p>
    <p class="mb-3">
      Par ailleurs, il est rappelé que conformément à l’article L214-3 du Code rural, il est interdit
      d'exercer des mauvais traitements envers les animaux domestiques.
    </p>
    <p class="mb-3">
      Enfin, il est rappelé que conformément à l’article 521-1 du Code pénal, le fait, publiquement
      ou non, d'exercer des sévices graves ou de commettre un acte de cruauté envers un animal
      domestique, ou apprivoisé, ou tenu en captivité, est puni de trois ans d'emprisonnement et
    ...
    <p class="mb-3">
      L’adoptant devra venir à la chatterie pour rencontrer le chaton, dès la 4
      ème semaine, après avoir convenu d’un rendez-vous avec le Vendeur.
    </p>
    <p class="mb-3">
    ...
    <p class="mb-3">
      A défaut de venir récupérer le chaton dans le délai convenu, l’adoptant sera considéré comme
      ayant renoncé à l’achat du chaton lequel sera de nouveau disponible à la vente.
    </p>
    <p class="mb-3">
    ...
    <p class="mb-3">
      Le Vendeur se réserve le droit de refuser la remise du chaton pour des raisons motivées et
      dans l’intérêt du chaton.
    </p>
    <p class="mb-3">
      Lors du retrait du chaton, le Vendeur remet à l’adoptant :</p>
    <ul class="space-y-1 list-disc list-inside mb-2">
      <li>Le carnet de santé du chaton,</li>
      <li>Un certificat de bonne santé établi par le vétérinaire référent du Vendeur,</li>
      <li>La copie des tests ADN et échographie des parents,</li>
      <li>Le pédigrée LOOF ou le numéro provisoire,</li>
    ...
    <ul class="space-y-1 list-disc list-inside mb-2">
      ...
      <li>Faire stériliser le chaton,</li>
    ...
    <p class="mb-3">L’adoptant s’engage à poursuivre les rappels de vaccination du chaton ainsi que le traitement
      de vermifuge régulièrement conformément aux recommandations du Vendeur.</p>
    <p class="mb-3">L’adoptant s’engage à accorder au chaton tous les soins indispensables à sa bonne santé et à
      son équilibre.</p>
    <p class="mb-3">L’adoptant s’interdit de revendre ou de donner à qui que ce soit le chaton adopté sans en
    ...
    <p class="mb-3">Les contestations et différends, de quelque nature qu’ils soient, qui pourraient naître à
      ...
      retrouveront toute liberté afin d’user des voies de droit qui leur sont ouvertes. Le différend
      sera soumis à la juridiction du Tribunal Judiciaire de Soissons.</p>
  </div>
</template>
